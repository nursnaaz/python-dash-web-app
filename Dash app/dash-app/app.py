...
def bigfoot_dow(sightings):
    ...
    return {
        ...
        "layout": {
            "title": "Customer Complaints by Day of Week",
        }
    }
...
app.layout = html.Div([
    ...
    html.Div([
        # Column: Title
        html.Div([
            html.H1("Video Collaboration", className="text-center")
        ], className="col-md-12")
    ], className="row"),
...
if __name__ == "__main__":
    app.run_server(host='0.0.0.0', port=8087)
